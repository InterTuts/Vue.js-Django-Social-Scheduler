...
import ConnectView from '../views/networks/ConnectView.vue';
import CallbackView from '../views/networks/CallbackView.vue';
...
router.beforeEach(async (to, from, next) => {
  ...
  if (to.meta.noAuth) {
    ...
    // Chceck if error message exists exists
