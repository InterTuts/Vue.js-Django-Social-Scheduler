...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: () => t('change_password_page_description'),
    },
...
const { updateRequest, successMessage, errorMessage, isLoading } =
  usePassword();
        ...
        <v-row>
          <v-col cols="12">
            <v-text-field
              ...
              :counter="20"
              :error-messages="
                v$.repeat_password.$errors.map((e) => e.$message.toString())
              "
        ...
        <v-row>
          <v-col cols="12">
            ...
            >
              {{ $t('save') }}
              <span
                class="mdi mdi-arrow-right-bold auth-main-form-submit-icon"
              ></span>
              <span
                class="mdi mdi-cached rotate-animation auth-main-form-submitting-icon"
              ></span>
            </v-btn>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12">
            <div class="auth-main-form-alerts">
              ...
              >
                <span
                  class="mdi mdi-bell-outline auth-main-form-alert-success-icon"
                ></span>
                <p>{{ successMessage }}</p>
              </div>
              <div
              ...
              >
                <span
                  class="mdi mdi-bell-outline auth-main-form-alert-error-icon"
                ></span>
                <p>{{ errorMessage }}</p>
              </div>
            </div>
          ...
          <v-col cols="12">
            <div class="auth-additional-link">
              <p>
                ...
                <router-link
                  to="/"
                  class="inline-block auth-main-form-reset-link"
                >
                  {{ $t('sign_in') }}
                </router-link>
              </p>
